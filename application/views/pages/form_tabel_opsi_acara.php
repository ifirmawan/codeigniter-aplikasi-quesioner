...
<?php if (isset($opsi_id)) { ?>
	<form action="<?php echo site_url('admin/simpan_opsi_acara/'.$opsi_id);?>" method="post" >
<?php } ?>
  <div class="row" style="padding-bottom: 10px;">
    <?php if(isset($answered) && $answered) : ?>
 ...
 <div class="col-xs-12 col-md-9">
    ...
    <div class="col-xs-12 col-md-3">
        <div class="text-right">
          ...
          <?php if(isset($kues_id)): ?>
            <a href="<?php echo site_url($my['is'].'/buat_pertanyaan/'.$kues_id);?>" class="btn btn-inline btn-success-outline" style="margin-right: 0px;">
    ...
    <div class="col-xs-12 col-md-2">
      Opsi Jawaban
      <input type="checkbox" name="opsi_jawaban" value="1" />
    </div>
    <div class="col-xs-12 col-md-3">
        <div class="text-right">
          <button type="submit" class="btn btn-inline btn-primary">Tambah</button>
                ...
                <td>
                  <div class="btn-group btn-group-sm" role="group" aria-label="...">
                    <?php
                        ...
                        if (!is_null($value->jenis_opsi) && $value->jenis_opsi!='teks') {
                            switch ($value->jenis_opsi) {
                              case 'check':

                                # code...set_opsi_jawaban
                                break;
                              case 'radio':
                                # code...
                                break;
