	    ...
	    <ul class="side-menu-list">
	        <li class="blue">
	            <a href="<?php echo site_url($my['is'].'/index');?>">
	                <i class="font-icon fa fa-file-o"></i>
	                <span class="lbl">Kuesioner</span>
	            </a>
	        </li>
	        <li class="blue">
	            <a href="<?php echo site_url($my['is'].'/tanggapan');?>">
	                <i class="font-icon fa fa-reply"></i>
	                <span class="lbl">Tanggapan</span>
	            </a>
	        </li>
	        <li class="blue">
	            <a href="<?php echo site_url($my['is'].'/daftar_pakar');?>">
	                <i class="font-icon fa fa-user-md"></i>
	                <span class="lbl">Pakar</span>
	            </a>
	        </li>
	        <li class="blue">
	            <a href="<?php echo site_url($my['is'].'/daftar_user');?>">
	                <i class="font-icon fa fa-user"></i>
	                <span class="lbl">Semua user</span>
	            </a>
	        </li>	                	                
	        </ul>
	    </section>
...
<?php echo (isset($halaman))? $halaman : '';?>
	...
	<script src="<?php echo base_url('public/');?>js/custom.pie.highcarts.js"></script>
	<script src="<?php echo base_url('public/');?>js/custom.kues.js"></script>
